...
class ColorAssets {
  ...
  constructor(args, json) {
    if (json) {
      ...
      Object.assign(this, ColorAssets.Model, {
        color: {
          alpha: color.a,
          blue: color.b / 255,
          green: color.g / 255,
  ...
  _getTinyColor() {
    return TinyColor({
      r: Math.round(this.color.red * 255),
      g: Math.round(this.color.green * 255),
      b: Math.round(this.color.blue * 255),
      a: this.color.alpha,
    });
  }
}

module.exports = ColorAssets;
